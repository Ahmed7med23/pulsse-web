...
class FriendsController extends Controller
{
    ...
    public function sendInvitation(Request $request)
    {
        ...
        $message = "💙 {$inviterName} يدعوك لتجربة *نبض* - نبضة دافئة في عالم رقمي متسارع!\n\n🌟 *هي جسر يربط القلوب المشغولة بضغطة زر، تختصر المسافات وتتجاوز حواجز الوقت*\n\n✨ *منصة عصرية تحول الذكريات العابرة إلى لحظات تواصل حقيقية*\n\n🎯 *مميزات رائعة:*\n• نبضات سريعة تصل في ثوانٍ 💫\n• دوائر ذكية للعائلة والأصدقاء والزملاء 👥\n• واجهة أنيقة وسهولة فائقة في الاستخدام 🎨\n• تواصل حقيقي بدون تعقيدات 💬\n• أنت على بُعد نبضة واحدة من كل من يهمك ❤️\n\n🚀 في عالم تتزاحم فيه المواعيد، *نبض* يقدم حلاً ذكياً يجمع بين بساطة النكزة وعمق المشاعر\n\n🔗 *انضم الآن مجاناً:*\n{$registrationLink}\n\nكود الدعوة: *{$invitation->invitation_code}*\n\n_لأن بعض العلاقات تحتاج فقط لنبضة لتظل حية!_ 💫\n\n*pulsse app* - One Pulse Away 🌟";
